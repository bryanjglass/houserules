# typescript-tooling Specification

## Purpose
The build and type-checking contract for the repo: both workspaces are TypeScript, compile under a strict config, share one source of truth for domain string-unions, and preserve the existing build/run behavior. Created by archiving change convert-to-typescript.
