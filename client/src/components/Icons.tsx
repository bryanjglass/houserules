...
export const TasksIcon = ({ size = 22, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const CalendarIcon = ({ size = 22, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const WalletIcon = ({ size = 22, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const MoreIcon = ({ size = 22, ...p }: IconProps) => (
...
export const PlusIcon = ({ size = 22, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
    <path d="M12 5v14M5 12h14" />
  </svg>
);

export const SettingsIcon = ({ size = 22, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const StarIcon = ({ size = 16, filled = true, ...p }: IconProps & { filled?: boolean }) => (
